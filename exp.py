...
parser.add_argument('--model_name', type=str, default='agga-fln', help='model name: tcaffn,dca-asffn,agga-fln')
parser.add_argument('--dataset_name', type=str, default='solar', help='dataset name: ett(h1,h2,m1,m2), metr_la, pems_bay, pems04, pems08, taxibj13 (13-16)'+
                    'electricity,rate,illness,traffic,weather,dsmt,tjg-1-20,solar')
parser.add_argument('--graphgen_name', type=str, default='None', help='图生成器名, CLGSDN; None: not use')
